...
activities = {
    ...
    "Soccer Team": {
        ...
        "schedule": "Mondays and Thursdays, 4:00 PM - 6:00 PM (Games on Saturdays)",
        "max_participants": 25,
    ...
    "Drama Club": {
        "description": "Acting, playwriting, and stage production",
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions with hands-on challenges and experiments",
        "schedule": "Saturdays, 9:00 AM - 12:00 PM",
        "max_participants": 24,
        "participants": ["ethan@mergington.edu", "abigail@mergington.edu"]
    }
}
...
@app.delete("/activities/{activity_name}/participants", status_code=status.HTTP_200_OK)
